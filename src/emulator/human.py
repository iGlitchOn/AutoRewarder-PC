...
class HumanBehavior:
    ...
    def __init__(self, driver, show_cursor=True, mobile=False, stop_event=None):
        """
        Args:
            ...
            stop_event: Optional threading.Event; long dwells abort on Stop.
        """
    ...
    def _pause(self, seconds):
        """Sleep, but return immediately if Stop was requested."""
        from ..utils import wait_or_stop

        return wait_or_stop(seconds, self.stop_event)
    ...
    def scroll_page(self):
        ...
        # Wait a bit after scrolling (interruptible — Stop must not sit here)
        self._pause(random.uniform(5, 10))
